...
export default function VisitasAgendadas() {
  ...
  useEffect(() => {
    ...
    async function fetchVisits() {
      try {
        ...
        const res = await fetch(`https://domuhouse-express.onrender.com/api/agents/${agentId}/visits`)
  ...
  async function changeVisitStatus(visitId, newStatus) {
    try {
      const response = await fetch(`https://domuhouse-express.onrender.com/api/visits/${visitId}/status`, {
        method: "PATCH",
        headers: {
  ...
  async function editVisit(visitId, updatedData) {
    try {
      const response = await fetch(`https://domuhouse-express.onrender.com/api/visits/${visitId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
