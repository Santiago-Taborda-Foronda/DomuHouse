                    ...
                    return (
                      <div key={index} className="flex items-center gap-4">
                        ...
                        <div className="flex-1 bg-gray-100 rounded-full h-8 relative">
                          <div 
                            className="bg-[#2F8EAC] h-8 rounded-full flex items-center justify-between px-3"
                  ...
                  {reportesData.crecimientoClientela.slice(-6).map((item, index) => {
                    ...
                    return (
                      <div key={index} className="flex items-center gap-4">
                        ...
                        <div className="flex-1 bg-gray-100 rounded-full h-8 relative">
                          <div 
                            className="bg-purple-500 h-8 rounded-full flex items-center justify-between px-3"
                ...
                <div className="space-y-4">
                  {reportesData.topAgentes.map((agente, index) => (
                    <div key={index} className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                      <div className="flex items-center justify-center w-8 h-8 bg-[#2F8EAC] text-white rounded-full text-sm font-bold">
                        {index + 1}
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className={`flex items-center gap-1 ${agente.crecimiento >= 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                {reportesData.tiposPropiedades.map((tipo, index) => {
                  const colores = ['bg-[#2F8EAC]', 'bg-green-500', 'bg-purple-500', 'bg-orange-500'];
                  return (
